...
useCallback(()=>{
  ...
  return (
    ...
    <> 
      ...
      className="fixed bottom-0 p-3 dark:bg-black bg-violet-500 dark:text-white  text-purple ">
      ...
      <option value="light" >Light</option>
       ...
       setHistory={setHistory}/>
        ...
        {    loader ? 
          ...
          {/* Search input  */}
          <div className='dark:bg-zinc-800 bg-zinc-600  w-1/2 text-white m-auto rounded-4xl border pr-5 border-zinc-600 
                          flex p-1 h-16 '>
            <input
              onKeyDown={isEnter}
